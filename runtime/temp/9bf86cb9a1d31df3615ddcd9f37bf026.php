<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:63:"/home/wwwroot/default/wstmart/home/view/default/settlement.html";i:1509890900;s:57:"/home/wwwroot/default/wstmart/home/view/default/base.html";i:1509890900;s:69:"/home/wwwroot/default/wstmart/home/view/default/self_shop_header.html";i:1509890900;s:63:"/home/wwwroot/default/wstmart/home/view/default/header_top.html";i:1509890900;s:63:"/home/wwwroot/default/wstmart/home/view/default/shop_apply.html";i:1509890898;s:59:"/home/wwwroot/default/wstmart/home/view/default/header.html";i:1509890898;s:59:"/home/wwwroot/default/wstmart/home/view/default/footer.html";i:1509890900;}*/ ?>
<!doctype html>
<head>
...
<div class="wst-container">
  <div id="stepflex" class="stepflex">
    ...
    <div class='cart-box2'>
       ...
       <?php $shopFreight = 0; if(is_array($carts["carts"]) || $carts["carts"] instanceof \think\Collection): $i = 0; $__LIST__ = $carts["carts"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;
       ...
       <div class='cart-item'>
        ...
        <img border="0" src="http://wpa.qq.com/pa?p=1:<?php echo $vo['shopQQ']; ?>:7" alt="QQ交谈" width="71" height="24"/>
      </a>
          <?php endif; if($vo['shopWangWang'] !=''): ?>
          <a target="_blank" href="http://www.taobao.com/webww/ww.php?ver=3&touid=<?php echo $vo['shopWangWang']; ?>&siteid=cntaobao&status=1&charset=utf-8">
        <img border="0" src="http://amos.alicdn.com/realonline.aw?v=2&uid=<?php echo $vo['shopWangWang']; ?>&site=cntaobao&s=1&charset=utf-8" alt="和我联系" />
      </a>
          <?php endif; ?>
          </div>
          <div class='goods-list'>
            ...
            <div class='wst-clear'></div>
             ...
             <div class='shop-remark selected2'>
              订单备注：<input type='text' id="remark_<?php echo $vo['shopId']; ?>" class='j-ipt' style='width:700px;' maxLength='100' placeholder='给卖家留言'/>

             <div style="float: right;margin-top:-10px;">
             <p style="text-align:right;padding-right:13px;">
              <span style="text-align: right;line-height: 30px;">运费：<span id="shopF_<?php echo $vo['shopId']; ?>" style='font-weight: bold;color: #E55356;'>￥<?php echo $freight; ?></span></span>
            </p>
             <span style='text-align:right;line-height:30px;padding-right:13px;'>店铺合计(含运费)：<span id="shopC_<?php echo $vo['shopId']; ?>" v="<?php echo $vo['goodsMoney']; ?>" style='font-weight: bold;color: #E55356;'>￥<?php echo $freight+$vo['goodsMoney']; ?></span></span>
             </div>
